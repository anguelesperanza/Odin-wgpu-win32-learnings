...
create_quad :: proc() -> (wgpu.Buffer, wgpu.Buffer) {
	vertices:[4]Vertex = {
	    { position = {-0.5, 0.5, 0.0}, color = {1, 0.0, 0.5} }, // A
	    { position = {0.5, 0.5, 0.0}, color = {0, 0.0, 1} }, // B
	    { position = {0.5, -0.5, 0.0}, color = {0.5,1, 0.5} }, // C
	    { position = {-0.5, -0.5, 0.0}, color = {0.4, 0.0, 0.5} }, // D
	}
